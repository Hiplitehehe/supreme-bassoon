...
class AkairoHandler extends events_1.default {
    ...
    constructor(client, options) {
        const { directory, classToHandle = AkairoModule_js_1.AkairoModule, extensions = [".js", ".json", ".ts"], automateCategories = false, loadFilter = () => true } = options ?? {};
        if (typeof directory !== "string")
            throw new TypeError("options.directory must be a string.");
        if (classToHandle !== AkairoModule_js_1.AkairoModule && !(classToHandle.prototype instanceof AkairoModule_js_1.AkairoModule))
