...
class ContentParser {
    ...
    static getFlags(args) {
        ...
        for (const arg of args) {
            const arr = res[arg.match === Constants_js_1.ArgumentMatches.FLAG ? "flagWords" : "optionFlagWords"];
            if (arg.match === Constants_js_1.ArgumentMatches.FLAG || arg.match === Constants_js_1.ArgumentMatches.OPTION) {
