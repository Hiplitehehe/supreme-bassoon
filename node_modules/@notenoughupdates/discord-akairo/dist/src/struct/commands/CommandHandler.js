...
exports.RegisterInteractionCommandError = exports.CommandHandler = void 0;
...
class CommandHandler extends AkairoHandler_js_1.AkairoHandler {
    ...
    constructor(client, options) {
        ...
        if (!(classToHandle.prototype instanceof Command_1.Command || classToHandle === Command_1.Command)) {
            throw new AkairoError_js_1.AkairoError("INVALID_CLASS_TO_HANDLE", classToHandle.name, Command_1.Command.name);
        }
    ...
    async registerInteractionCommands() {
        ...
        for (const key in this.client) {
            if (this.client[key] instanceof ContextMenuCommandHandler_js_1.ContextMenuCommandHandler) {
