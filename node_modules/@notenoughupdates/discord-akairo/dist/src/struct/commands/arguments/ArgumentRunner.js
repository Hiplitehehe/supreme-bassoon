...
class ArgumentRunner {
    ...
    static isShortCircuit(value) {
        return Flag_js_1.Flag.is(value, Flag_js_1.FlagType.Cancel) || Flag_js_1.Flag.is(value, Flag_js_1.FlagType.Retry) || Flag_js_1.Flag.is(value, Flag_js_1.FlagType.Continue);
    }
    /**
